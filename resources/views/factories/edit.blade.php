    ...
    <div class="py-8 px-6 max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            <div class="px-6 pt-6 pb-4 border-b border-gray-200 flex justify-between items-start">
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">Edit Factory</h3>
                    <p class="text-sm text-gray-500 mt-0.5">Update factory record</p>
                </div>
            ...
            <div class="p-6">
                <form action="{{ route('factories.update', $factory) }}" method="POST" class="max-w-lg space-y-5">
                    @csrf
                    @method('PUT')
